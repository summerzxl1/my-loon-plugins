...
try {
  if (body) {
    ...
    // 过滤广告配置
    if (obj.data && obj.data.adConfig) obj.data.adConfig = null;
    if (obj.data && obj.data.adInfo) obj.data.adInfo = null;
    if (obj.data && obj.data.ads) obj.data.ads = [];
    if (obj.data && obj.data.advertList) obj.data.advertList = [];
    
    // 过滤弹窗广告
    if (obj.data && obj.data.popup) obj.data.popup = null;
    if (obj.data && obj.data.popupAd) obj.data.popupAd = null;
    ...
    // 过滤横幅广告
    if (obj.data && obj.data.banner && Array.isArray(obj.data.banner)) {
    ...
    // 过滤浮窗广告
    if (obj.data && obj.data.floatAd) obj.data.floatAd = null;
    if (obj.data && obj.data.floatLayer) obj.data.floatLayer = null;
